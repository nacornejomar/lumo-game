...
import { memDb } from '@/lib/memoryStore';
...
export async function POST(
  ...
  try {
    ...
    if (pendingHumanQ) {
      ...
      // Turn passes to AI (the answerer per game rules)
    ...
    // Guess when <= 2 remain or asked 8+ questions
    ...
    // Ask the best remaining question
    ...
    // Turn stays on AI until human answers (same mechanics as human asking)
